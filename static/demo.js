...
if (query.has('code') && initial_code != default_code) {
    ...
    output_area.innerHTML =
        '<p><span class="phan_file">input</span>:<span class="phan_line">13</span>: <span class="phan_issuetype_normal">SecurityCheck-XSS</span> Calling method <span class="phan_functionlike">\\printUnsafe</span>() in <span class="phan_functionlike">[no method]</span> that outputs using tainted argument <span class="phan_code">#1 (`$values[\'unsafe\']`)</span>.<span class="phan_details"> (Caused by: input +3)</span><span class="phan_details"> (Caused by: input +9)</span><span class="phan_details"></span></p>' +
        '<p><span class="phan_file">input</span>:<span class="phan_line">14</span>: <span class="phan_issuetype_normal">SecurityCheck-DoubleEscaped</span> Calling method <span class="phan_functionlike">\\printSafe</span>() in <span class="phan_functionlike">[no method]</span> that outputs using tainted argument <span class="phan_code">#1 (`$values[\'escaped\']`)</span>.<span class="phan_details"> (Caused by: input +6)</span><span class="phan_details"> (Caused by: input +9)</span><span class="phan_details"></span></p>' +
        '<p><span class="phan_file">input</span>:<span class="phan_line">19</span>: <span class="phan_issuetype_critical">SecurityCheck-SQLInjection</span> Calling method <span class="phan_functionlike">\\queryUnsafe</span>() in <span class="phan_functionlike">[no method]</span> that outputs using tainted argument <span class="phan_code">#1 (`$userName`)</span>.<span class="phan_details"> (Caused by: input +25; annotations in \\queryDatabase)</span><span class="phan_details"> (Caused by: input +17)</span><span class="phan_details"></span></p>';
}
